...
def generate(filename, version):
    return {
        ...
        'targetAbi': '10.9.0.0',
        'sourceUrl': 'https://github.com/czkwg8/jellyfin-plugin-metatube/releases/download/'
...
def main():
    ...
    with urlopen('https://raw.githubusercontent.com/czkwg8/jellyfin-plugin-metatube/dist/manifest.json') as f:
